...
def load_image_b64(filepath: Path) -> str | None:
    """Load image file and return base64 data URI, or None if missing."""
    if filepath.exists():
...
#              PROJECT DATA + IMAGES
# ═══════════════════════════════════════════════════════
PROJ_DIR = Path("assets/project")

# Map project IDs to image filenames
IMAGE_MAP = {
    "portfolio": "pro1.png",
    "face":      "pro2.png",
    "grocery":   "pro3.png",
...
PROJECTS = [
  {
    ...
    "color": "#00d4ff",
    "ga": "#00d4ff", "gb": "#0ea5e9",
    "description": "An intelligent OS-level AI assistant designed for seamless local automation, featuring system-integrated task execution, privacy-focused local processing via Ollama, and a futuristic terminal-inspired interface for controlling your digital environment through natural language.",
    "tech": ["Python"],
    "status": "Live",
    "year": "2024",
    "difficulty": "Intermediate",
    "features": ["Responsive design", "Dark theme", "Smooth animations", "Custom navigation"],
    "image": None,  # Will be overridden by b64 if file exists
    "liveUrl": "#",
    "sourceUrl": "#",
  },
  {
    ...
    "color": "#ff6bcb",
    "ga": "#ff6bcb", "gb": "#e879f9",
    "description": "An immersive 3D survival experience built with Three.js and Cannon.js, featuring procedural zombie spawning, dynamic lighting for a tense atmosphere, and smooth character physics designed to test player reflexes in a post-apocalyptic environment.",
    "tech": ["Three.js", "React"],
    "status": "Completed",
    "year": "2024",
    "difficulty": "Advanced",
    "features": ["Web", "Nada", "98% accuracy"],
    "image": None,
    "liveUrl": None,
    "sourceUrl": "#",
  },
  {
    ...
    "color": "#a78bfa",
    "ga": "#a78bfa", "gb": "#818cf8",
    "description": "A high-end 3D design tool and real-time engine used to create interactive 3D web content, featuring a collaborative workspace that allows developers to export scenes directly to code frameworks like React, Three.js, or vanilla JavaScript without the complexity of traditional game engines.",
    "tech": ["React", "Three.js","Spline"],
    "status": "Completed",
    "year": "2024",
    "difficulty": "Advanced",
    "features": ["Eagle", "Robocap"],
    "image": None,
    "liveUrl": None,
    "sourceUrl": "#",
  },
  {
    ...
    "color": "#34d399",
    "ga": "#34d399", "gb": "#10b981",
    "description": "A high-performance WebGL space simulation developed using Three.js and React Three Fiber, featuring procedural starfield generation, realistic planetary shaders with custom glsl textures, and an orbital physics engine designed for seamless exploration of a scaled digital cosmos.",
    "tech": ["React", "Three.js"],
    "status": "Completed",
    "year": "2023",
    "difficulty": "Intermediate",
    "features": ["Space", "Galaxy"],
    "image": None,
    "liveUrl": "#",
    "sourceUrl": "#",
  },
  {
    ...
    "color": "#fde68a",
    "ga": "#fde68a", "gb": "#f59e0b",
    "description": "A comprehensive Healthcare Management System designed to bridge the gap between patients and providers, featuring secure electronic health records (EHR), automated appointment scheduling, and real-time medical data visualization for improved clinical decision-making.",
    "tech": ["Php", "Bootstrap"],
    "status": "Completed",
    "year": "2023",
    "difficulty": "Intermediate",
    "features": ["Alerts","Realtime"],
    "image": None,
    "liveUrl": "#",
    "sourceUrl": "#",
  },
  {
    ...
    "color": "#818cf8",
    "ga": "#818cf8", "gb": "#6366f1",
    "description": "An autonomous AI Development Orchestrator designed to bridge the gap between ideation and deployment. This agentic framework utilizes a multi-model architecture to perform high-level planning, recursive code generation, and self-correcting debugging, transforming complex project requirements into production-ready software systems with minimal human intervention.",
...
# Inject base64 images into each project
for proj in PROJECTS:
    pid = proj.get("id")
    fname = IMAGE_MAP.get(pid)
    if fname:
        proj["b64"] = load_image_b64(PROJ_DIR / fname)
    else:
        proj["b64"] = None

# Serialize for safe JS injection
projects_json = json.dumps(PROJECTS, ensure_ascii=False)

# ═══════════════════════════════════════════════════════
#              FULL HTML/JS COMPONENT
# ═══════════════════════════════════════════════════════
components.html(f"""
<!DOCTYPE html>
<html lang="en">
...
// ── Project Data (INJECTED FROM PYTHON) ─────────────────────
...
function renderGrid(filter) {{
  ...
  list.forEach(p => {{
    ...
    // ── IMAGE LOGIC: b64 > image URL > placeholder ──
...
function openModal(p) {{
  ...
  // ── Modal Image: b64 > image URL > placeholder ──
  const imgWrap = document.getElementById('modalImg');
  const modalSrc = p.b64 || p.image;
  imgWrap.innerHTML = modalSrc
    ? `<img src="${{modalSrc}}" alt="${{p.title}}">`
